...
import "./CollateralAndFees.css";

type CollateralAndFeesType = {
  eqprice?: string;
};

const CollateralAndFees: FunctionComponent<CollateralAndFeesType> = ({
  eqprice = "0",
}) => {
  return (
...
export default CollateralAndFees;
