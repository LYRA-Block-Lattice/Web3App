  ...
  return (
    <div className="previewsellorderform">
      ...
      <div className="nft-name1">
        <div className="a-great-dao">{obj.selltoken}</div>
      </div>
      <div className="im-selling">Buyer will pay me by:</div>
      <div className="nft-name1">
        <div className="a-great-dao">{obj.gettoken}</div>
      </div>
      <div className="im-selling">Price, amount, and I’ll get:</div>
      <div className="nft-name-parent">
        <div className="nft-name3">
          <div className="total">{obj.price}</div>
        </div>
        <div className="x">X</div>
        <div className="nft-name3">
          <div className="total">{obj.count}</div>
        </div>
        <div className="x">=</div>
        <div className="nft-name3">
          <div className="total">{obj.price * obj.count}</div>
        </div>
      </div>
